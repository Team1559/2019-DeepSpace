...
public interface Constants {
	...
	public static final int STEPPER_COPILOT_LIFT_UP_POT = 99; //TODO: needs to be set
	public static final int STEPPER_COPILOT_LIFT_DOWN_POT = 99; //TODO: needs to be set
